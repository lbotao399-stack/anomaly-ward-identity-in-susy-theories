...
$$
\Gamma_{C,\mathrm{pole}}^{A|B}=-\frac{g^2}{128\pi^2\epsilon}c_{ACD}c_{BCE}\widetilde W^D_{\dot\alpha}(q)(ip^n)X^E(p)
(\sigma_E^m\bar\sigma_E^n\sigma_E^r)_+{}^{\dot\alpha}\delta^{(4)}_{mr}.
$$

$$
\Gamma_{\triangle+C,\mathrm{pole}}^{A|B}=\frac{g^2}{128\pi^2\epsilon}c_{ACD}c_{BCE}\widetilde W^D_{\dot\alpha}(q)(ip^n)X^E(p)
...
$$
\Gamma_{\mathrm{anom}}^{A|B}=\frac{g^2}{64\pi^2}c_{ACD}c_{BCE}\widetilde W^D_{\dot\alpha}(q)(ip_+{}^{\dot\alpha})X^E(p).
$$

$$
\Gamma_{\mathrm{anom}}^{B|A}=-\frac{g^2}{64\pi^2}c_{BCD}c_{ACE}\widetilde W^D_{\dot\alpha}(q)(ip_+{}^{\dot\alpha})X^E(p).
$$

In the reflected term relabel $D\leftrightarrow E$; since $|X|=0$:

$$
\Gamma_{\mathrm{anom}}^{A|B}+\Gamma_{\mathrm{anom}}^{B|A}
...
| trace | $D_-$ | $\bar D$ edge | $D$ edge | endpoint sign | external Koszul sign | numerator | triangle pole | contact pole |
|---|---|---|---|---:|---:|---|---|---|
