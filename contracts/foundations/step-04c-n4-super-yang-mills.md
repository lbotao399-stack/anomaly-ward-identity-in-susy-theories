...
+i\Lambda^{\mathcal I}\sigma_{L,\mu}
\bar\varepsilon_{\mathcal I}.}
\tag{4C.24}
$$
...
+i\lambda\sigma_{L,\mu}\bar\varepsilon_4,
\end{aligned}
\tag{4C.28}
$$
...
-\Lambda^{\mathcal I}\sigma_{E,m}
\widetilde\varepsilon_{\mathcal I},}
\tag{4C.44}
$$
