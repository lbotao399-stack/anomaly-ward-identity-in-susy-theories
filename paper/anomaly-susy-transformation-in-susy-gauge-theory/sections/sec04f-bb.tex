...
$-f^{ACD}f^{BCE}$; including the product Koszul and source-attachment signs,
the net route signs are
...
\times M_{\mathrm{ext}}\times\big(\pm f^{ACD}f^{BCE}\times s_{00n}\big),
\end{equation}
